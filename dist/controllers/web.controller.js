...
export const getcontentstype = async (req, res) => {
    try {
        const { type } = req.body;
        if (!type) {
...
export const editcontents = async (req, res) => {
    try {
...
//Roles
export const editroleid = async (req, res) => {
    try {
...
export const checkroleid = async (req, res) => {
    try {
