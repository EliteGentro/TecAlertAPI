...
import { addfaq, getfaqs, editfaq, deletefaq, 
    addcontent, getcontents, getcontentstype, editcontents, deletecontents,
    editroleid,checkroleid } from '../controllers/web.controller.js';
